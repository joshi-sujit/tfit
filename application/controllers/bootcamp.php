...
class Bootcamp extends CI_Controller{
	...
	public function index(){
		$query = $this->db->get('tbl_bootcamp_content');
	...
	public function getById(){
		...
		$data['query'] = $this->db->query("SELECT * FROM tbl_bootcamp_content WHERE content_id='$id'");
		$this->load->view('admin/bootcamp/manageContent',$data);
	}
	...
	public function save(){
		...
		$this->db->update('tbl_bootcamp_content', $data); 
		$redirect=base_url()."bootcamp/index/"."editsuccess";
		redirect($redirect);
	}
